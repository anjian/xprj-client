 ...
 * 
 * <p>
 * This version is modified by <a href="mailto:yixx@ucweb.com">Roger Yi</a>, use
 * the original English string to replace localize Message's methods.
 * </p>
 * 
 * @see StringWriter
 */
public class StringReader extends Reader {
	 ...
	 *             if {@code offset < 0} or {@code len < 0}, or if {@code offset
	 *             + len} is greater than the size of {@code buf}.
	 * @throws IOException
	 *             if this reader is closed.
	 */
