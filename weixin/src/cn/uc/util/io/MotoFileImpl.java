/**
 * Tiny.cn.uc.util.io.MotoFileImpl.java, 2011-4-11
 *
...
/**
 * Moto FileConnection Wrapper Implementation.
 * 
 * @author <a href="mailto:yixx@ucweb.com">Roger Yi</a>
 * @since 1.0
 * @version 1.0
 */
class MotoFileImpl extends File {

	private com.motorola.io.FileConnection fc;

	public MotoFileImpl(String aPath) throws IOException, SecurityException {

		fc = (com.motorola.io.FileConnection) Connector.open(aPath);
	}

	public MotoFileImpl(String aPath, int aMode) throws IOException,
		SecurityException {

		fc = (com.motorola.io.FileConnection) Connector.open(aPath, aMode);
	}
