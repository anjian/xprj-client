 ...
 * change the location of LINE_SEPARATOR.
 * </p>
 * 
...
public final class WordUtils {
	...
	public static String wrap(String str, int wrapLength, String newLineStr,
		...
		if (str == null)
			return null;
		if (newLineStr == null) {
			newLineStr = Platform.LINE_SEPARATOR;
		}
		if (wrapLength < 1) {
			wrapLength = 1;
		}
	...
	public static String capitalize(String str, char[] delimiters) {
		...
		for (int i = 0; i < strLen; i++) {
			...
			if (isDelimiter(ch, delimiters)) {
				...
				buffer.append(CharUtils.toTitleCase(ch));
	...
	public static String uncapitalize(String str, char[] delimiters) {
		...
		for (int i = 0; i < strLen; i++) {
			...
			if (isDelimiter(ch, delimiters)) {
				...
				buffer.append(CharUtils.toLowerCase(ch));
	...
	public static String swapCase(String str) {
		...
		for (int i = 0; i < strLen; i++) {
			...
			if (CharUtils.isUpperCase(ch)) {
				...
				if (whitespace) {
					tmp = CharUtils.toTitleCase(ch);
				}
				else {
					tmp = CharUtils.toUpperCase(ch);
				}
			}
			else {
				tmp = ch;
	 ...
	 * abbreviate a String.
	 * 
	 * @param str the string to be abbreviated. If null is passed, null is
	 *            returned.
