/**
 * Tiny.cn.uc.util.io.Jsr75FileImpl.java, 2011-4-11
 *
...
/**
 * JSR75 FileConnection Wrapper Implementation.
 * 
 * @author <a href="mailto:yixx@ucweb.com">Roger Yi</a>
 * @since 1.0
 * @version 1.0
 */
class Jsr75FileImpl extends File {

	private javax.microedition.io.file.FileConnection fc;

	public Jsr75FileImpl(String aPath) throws IOException, SecurityException {

		fc = (javax.microedition.io.file.FileConnection) Connector.open(aPath);
	}

	public Jsr75FileImpl(String aPath, int aMode) throws IOException,
		SecurityException {
	...
	public String[] getRootPaths() {
		...
		return CollectionUtils
			.toStringArray(javax.microedition.io.file.FileSystemRegistry
				.listRoots());
	}
