 ...
 * remove the part can not compiled with JavaMe SDK.
 * </p>
 * 
 * @see StringReader
 */
public class StringWriter extends Writer {
	 ...
	 * StringBuffer} is also the {@code lock} used to synchronize access
	 * to this
	 * writer.
	 */
	public StringWriter() {
	 ...
	 * subclasses,
	 * the other methods in {@code StringWriter} do not throw an {@code
	 * IOException} if {@code close()} has been called.
	 * 
	 * @throws IOException
